...
Keyword = 
[
'CppAD  cppad-20180000.0: A Package for Differentiation of C++ Algorithms  ',' algorithmic automatic derivative version cppad.hpp syntax introduction example include file preprocessor symbols namespace ',
...
'cmake_check  Checking the CppAD Examples and Tests  ',' purpose all windows subsets first level ',
...
'exp_apx.cpp  Correctness Tests For Exponential Approximation in Introduction  ',' main run running source ',
'AD  AD Objects  ',' require purpose base type requirements ',
'ad_ctor  AD Constructors  ',' convert base vecad syntax purpose implicit explicit example ',
...
'compound_assign  AD Compound Assignment Operators  ',' + add plus - subtract minus * multiply times / divide multiple syntax purpose base result operation sequence example derivative addition subtraction multiplication division ',
'AddEq.cpp  AD Compound Assignment Addition: Example and Test  ',' += plus ',
'sub_eq.cpp  AD Compound Assignment Subtraction: Example and Test  ',' -= plus add ',
'mul_eq.cpp  AD Compound Assignment Multiplication: Example and Test  ',' *= multiply plus add ',
'div_eq.cpp  AD Compound Assignment Division: Example and Test  ',' /= divide plus add ',
...
'subgraph_reverse  Reverse Mode Using Subgraphs  ',' syntax purpose notation basevector boolvector sizevector select_domain q ell col dw example ',
...
'subgraph_sparsity  Subgraph Dependency Sparsity Patterns  ',' syntax notation method atomic function boolvector sizevector select_domain select_range transpose pattern_out example ',
'subgraph_sparsity.cpp  Subgraph Dependency Sparsity Patterns: Example and Test  ',' ',
'sparse_jac  Computing Sparse Jacobians  ',' syntax purpose sizevector basevector sparse_jac_for sparse_jac_rev group_max subset pattern coloring cppad colpack work n_sweep uses forward example ',
...
'sparse_jacobian  Sparse Jacobian  ',' syntax purpose f row col work color_method n_sweep vectorbase vectorset restrictions vectorsize uses forward example ',
...
'sparse_hessian  Sparse Hessian  ',' syntax purpose f w work column subset row color_method colpack.star deprecated 2017-06-01 n_sweep vectorbase vectorset restrictions vectorsize uses forward example ',
...
'subgraph_jac_rev  Compute Sparse Jacobians Using Subgraphs  ',' syntax purpose method basevector sizevector boolvector f uses forward subset select_domain select_range matrix_out example ',
...
'preprocessor  CppAD API Preprocessor Symbols  ',' cppad_ null pointer purpose documented here cppad_debug_and_release cppad_null cppad_package_string cppad_use_cplusplus_2011 elsewhere deprecated ',
...
'thread_test.cpp  Run Multi-Threading Examples and Speed Tests  ',' purpose build program running a11c simple_ad team_example harmonic test_time max_threads mega_sum multi_newton num_zero num_sub num_sum use_ad implementations source ',
...
'multi_atomic.cpp  Multi-Threading User Atomic Example / Test  ',' source file ',
'multi_atomic_user  Defines a User Atomic Operation that Computes Square Root  ',' syntax purpose au num_itr y_initial y_squared ay limitations source ',
'multi_atomic_common  Multi-Threaded User Atomic Common Information  ',' purpose source ',
'multi_atomic_setup  Multi-Threaded User Atomic Set Up  ',' syntax purpose y_squared ok source ',
'multi_atomic_worker  Multi-Threaded User Atomic Worker  ',' purpose source ',
'multi_atomic_takedown  Multi-Threaded User Atomic Take Down  ',' syntax purpose square_root ok source ',
'multi_atomic_run  Run Multi-Threaded User Atomic Calculation  ',' syntax y_squared square_root ok source ',
'multi_atomic_time  Timing Test for Multi-Threaded User Atomic Calculation  ',' syntax time_out test_time num_threads num_solve ok ',
...
'sparse_rcv  Sparse Matrix Row, Column, Value Representation  ',' syntax sizevector valuevector empty pattern target nr nc nnz set k row_major col_major example ',
...
'speed_main  Running the Speed Test Program  ',' cppad uniform_01 syntax purpose package double profile correct seed global options onetape memory optimize atomic hes2jac subgraph sparsity boolsparsity revsparsity subsparsity colpack correctness results n_sweep link functions ',
...
'glossary  Glossary  ',' efficient ad function base type above elementary vector operation atomic sequence dependent independent parameter row-major representation sparsity pattern column index vectors boolean sets tape active inactive variable variables taylor coefficient ',
'Bib  Bibliography  ',' abramowitz stegun the c++ programming language evaluating derivatives numerical recipes shampine l.f. ',
'wish_list  The CppAD Wish List  ',' multi-threading atomic subgraph new api sparsity element-wise operations check_finite test_boolofvoid eigen example optimization taping special operators memory checkpoint retape testing compilation speed base requirements adolc forward mode recomputation iterator interface sequence software guidelines tracing atan2 benderquad ',
...
'deprecated  CppAD Deprecated API Features  ',' name changes atomic functions ',
